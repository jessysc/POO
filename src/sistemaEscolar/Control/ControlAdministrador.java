...
import sistemaEscolar.DAO.AdministradorDAO;
...
public class ControlAdministrador implements Pesquisavel<Administrador>, Crud<Administrador>, Login<Administrador>
{
     ...
     * retorna um valor booleano indicando se a inserção na lista e a persistencia no banco foram feitas com sucesso! 
     * @param administrador
     */
    @Override
     ...
     * email: String contendo email
     * retorna um valor booleano indicando se o email passado por parâmetro já existe.
     * @param email
     * @return 
     */
